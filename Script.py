...
<blockquote>😌 यह ᴍᴏᴠɪᴇ मुझे ᴍᴇʀᴇ ᴅᴀᴛᴀʙᴀꜱᴇ में नहीं मिली।</blockquote>"""
    ...
    DISCLAIMER_TXT = """
<b>📌 ᴄᴏɴᴛᴇɴᴛ & ᴄᴏᴘʏʀɪɢʜᴛ ɴᴏᴛɪᴄᴇ</b>

•  ᴀʟʟ ᴛʜᴇ ꜰɪʟᴇꜱ ɪɴ ᴛʜɪꜱ ʙᴏᴛ ᴀʀᴇ ꜰʀᴇᴇʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴏʀ ᴘᴏꜱᴛᴇᴅ ʙʏ ꜱᴏᴍᴇʙᴏᴅʏ ᴇʟꜱᴇ.

•  ᴊᴜꜱᴛ ꜰᴏʀ ᴇᴀꜱʏ ꜱᴇᴀʀᴄʜɪɴɢ, ᴛʜɪs ʙᴏᴛ ɪɴᴅᴇxᴇs ꜰɪʟᴇꜱ ᴛʜᴀᴛ ᴀʀᴇ ᴀʟʀᴇᴀᴅʏ ᴜᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ.

•  ᴡᴇ ʀᴇꜱᴘᴇᴄᴛ ᴀʟʟ ᴄᴏᴘʏʀɪɢʜᴛ ʟᴀᴡꜱ ᴀɴᴅ ᴡᴏʀᴋ ɪɴ ᴄᴏᴍᴘʟɪᴀɴᴄᴇ ᴡɪᴛʜ ᴅᴍᴄᴀ ᴀɴᴅ ᴇᴜᴄᴅ.

•  ɪꜰ ᴀɴʏᴛʜɪɴɢ ɪꜱ ᴀɢᴀɪɴꜱᴛ ʟᴀᴡ, ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ sᴏ ɪᴛ ᴄᴀɴ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ ᴀsᴀᴘ.

•  ɪᴛ ɪs ꜰᴏʀʙɪᴅᴅᴇɴ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ, ꜱᴛʀᴇᴀᴍ, ʀᴇᴘʀᴏᴅᴜᴄᴇ, ꜱʜᴀʀᴇ ᴏʀ ᴄᴏɴsᴜᴍᴇ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ\nᴇxᴘʟɪᴄɪᴛ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ᴄʀᴇᴀᴛᴏʀ ᴏʀ ʟᴇɢᴀʟ ᴄᴏᴘʏʀɪɢʜᴛ ʜᴏʟᴅᴇʀ.

•  ɪꜰ ʏᴏᴜ ʙᴇʟɪᴇᴠᴇ ᴛʜɪs ʙᴏᴛ ɪs ᴠɪᴏʟᴀᴛɪɴɢ ʏᴏᴜʀ ɪɴᴛᴇʟʟᴇᴄᴛᴜᴀʟ ᴘʀᴏᴘᴇʀᴛʏ, ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ\nᴛʜᴇ ʀᴇsᴘᴇᴄᴛɪᴠᴇ ᴄʜᴀɴɴᴇʟs ғᴏʀ ʀᴇᴍᴏᴠᴀʟ.

•  ᴛʜᴇ ʙᴏᴛ ᴅᴏᴇs ɴᴏᴛ ᴏᴡɴ ᴀɴʏ ᴏғ ᴛʜᴇꜱᴇ ᴄᴏɴᴛᴇɴᴛꜱ; ɪᴛ ᴏɴʟʏ ɪɴᴅᴇxᴇs ᴛʜᴇ ꜰɪʟᴇꜱ ꜰʀᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ.</b>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/the_hell_king_updates">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/the_hell_king_updates">[ ᴅʀᴇᴀᴍxʙᴏᴛᴢ ]</a></b>"""

    
    MOVIE_UPDATE_NOTIFY_TXT = """
<b><a href={poster_url}>📥</a><a href={imdb_url}>#𝑵𝒆𝒘_𝑭𝒊𝒍𝒆_𝑨𝒅𝒅𝒆𝒅 ✅\n\n {tag} </a></b>

<b>✨ ᴛɪᴛʟᴇ : <code>{filename}</code></b>


<b>🎭 ɢᴇɴʀᴇs : {genres}</b>

<b>ɢᴇɴʀᴇs 𝚃𝚊𝚐: {g_tag}</b>
...
<b>𝖴𝗉𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 - @Hell_king_69_Bot</b>

<b>🕒 𝙵𝚒𝚕𝚎 𝚞𝚙𝚕𝚘𝚊𝚍𝚎𝚍 𝚊𝚝: {file_time}</b>


<blockquote>ᴄᴏᴘʏ ᴛʜᴇ ɴᴀᴍᴇ ᴀɴᴅ ᴄʟɪᴄᴋ ᴏɴ <b>ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ</b> ʙᴜᴛᴛᴏɴ ᴀɴᴅ ᴘᴇꜱᴛ ᴛʜᴇ ɴᴀᴍᴇ ᴀᴛ ɢʀᴏᴜᴘ</blockquote>
"""
#     MOVIE_UPDATE_NOTIFY_TXT = """
# </b><a href={poster_url}>📥</a><a href={imdb_url}>#𝑵𝒆𝒘_𝑭𝒊𝒍𝒆_𝑨𝒅𝒅𝒆𝒅 ✅\n\n {tag} </a></b>
...
# <b>ʀᴇǫ ʙʏ : {message.from_user.mention}</b>"""
    ...
    # <b>🎬 <a href="{url}">{title}</a> <i>({year})</i></b>

    IMDB_TEMPLATE_TXT= caption = """

       
       ⚡️ <b>Shown In:</b> <code>{remaining_seconds}s</code>
       
       🎬 <b><a href="{url}">{title}</a></b>   (<a href="{url}/releaseinfo">{year}</a>)
       ⭐️ <b>Rating:</b> <a href="{url}/ratings">{rating}</a>/10
       🎭 <b>Genre:</b> <i>{genres}</i>
       🎧 <b>Audio:</b> <i>{languages}</i>

       👤 <b>Requested By:</b> {message.from_user.mention}
       <b>━━━━━━━━━━━━━━━</b>

       <i><a href="https://t.me/Hell_King_69_Bot">💎 Hell King Premium Bot</a></i>
"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/the_hell_king_updates'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/the_hell_king_updates'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
🔒 <i>This is a personal and private project.</i>  
🚫 <b>Re-uploading, copying, modifying, or selling this source code is strictly prohibited.</b>  
⚠️ <i>Unauthorized usage may lead to permanent ban or DMCA action.</i>

📦 <b>Official Project :</b>  
<a href="https://t.me/the_hell_king_updates">𝐇𝐞𝐥𝐥𝐊𝐢𝐧𝐠</a>

<b>💎 ━━━━━━━━━━━━━━━━━━━━━ 💎</b>
<i>© 2025 Hell King | All Rights Reserved</i>"""
...
• /sendall_mode - <code>[on/off]</code>
• /stream_mode all - <code>Everyone gets the watch/download button.</code>
• /stream_mode premium - <code>(Default) Only premium users and admins get the button.</code>
• /stream_mode off - <code>Nobody gets the button.</code>
"""
